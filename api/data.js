...
const EMPTY = { movimientos: [], ventas: [], vendedores: [], visitas: [], reparaciones: [], campanias: [], mktMedia: [], stock: [], produccion: [], ingresosMkt: [], nomPlanilla: [], fletesZonas: [], mktConfig: {}, _deleted: [] };
  ...
  if (req.method === 'POST') {
    try {
      ...
      const merged = {
        ...
        produccion: mergeArr(existing.produccion, body.produccion, delSet),
        ingresosMkt: mergeArr(existing.ingresosMkt, body.ingresosMkt, delSet),
        mktConfig: (body.mktConfig && typeof body.mktConfig === 'object') ? Object.assign({}, existing.mktConfig || {}, body.mktConfig) : (existing.mktConfig || {}),
        ...
        fletesZonas: (Array.isArray(body.fletesZonas) && body.fletesZonas.length) ? body.fletesZonas : (existing.fletesZonas || []),
